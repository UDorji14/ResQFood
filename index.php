...
<header class="site-nav" id="top">
    <nav class="nav-inner container" aria-label="Main navigation">
        <a href="#top" class="nav-logo" aria-label="ResQFood homepage">
...
<footer class="site-footer" id="contact">
    <div class="container footer-inner">
        ...
        <div class="footer-brand">
            <a href="#top" class="nav-logo" aria-label="ResQFood">
                <span class="logo-mark" aria-hidden="true">
    ...
    <div class="footer-base">
        <div class="container footer-base-inner">
            <small>&copy; <?= date('Y'); ?> ResQFood. All rights reserved.</small>
