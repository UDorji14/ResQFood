<?php
/**
 * ResQFood — Registration Page
 * Allows new businesses, general users, and charities to sign up.
 * Admins are created manually — not via this form.
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // ── Validation ────────────────────────────────────────────
    validateRequired($data, ['full_name', 'email', 'role', 'password'], $errors);
    ...
    if (empty($errors)) {
        ...
        try {
            ...
            $stmt->execute([
                ...
                $data['role'],
                'active',   // Change to 'pending' if email verification is needed
            ]);
            $userId = (int) $pdo->lastInsertId();

            // Create a role-specific profile stub
            if ($data['role'] === 'business') {
                ...
                $pdo->prepare('
                    INSERT INTO charity_profiles (user_id, organization_name)
                    VALUES (?, ?)
                ')->execute([$userId, $data['full_name']]);
            }
...
<head>
    ...
    <style>
        /* Role selector cards */
        .role-options { display: grid; grid-template-columns: repeat(3, 1fr); gap: 0.65rem; margin-top: 0.5rem; }
        ...
        .role-option label svg { opacity: 0.65; transition: opacity 150ms; }
        .role-option input:checked + label svg { opacity: 1; }
        @media (max-width: 400px) { .role-options { grid-template-columns: 1fr; } }
    </style>
</head>
    ...
    <div class="auth-card__body">
        ...
        <form method="POST" action="register.php" novalidate>
                ...
                <div class="role-options">
                    ...
                    <div class="role-option">
                        ...
                        <label for="role_business">
                            <svg viewBox="0 0 24 24" width="22" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M3 9l1-5h16l1 5H3z"/><rect x="5" y="9" width="14" height="12" rx="1"/><path d="M9 21V13h6v8"/></svg>
                            Food Business
                        </label>
                    </div>
                    ...
                    <div class="role-option">
                        ...
                        <label for="role_user">
                            <svg viewBox="0 0 24 24" width="22" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="12" cy="7" r="4"/><path d="M4 21v-1a8 8 0 0116 0v1"/></svg>
                            General User
                        </label>
                    </div>
                    ...
                    <div class="role-option">
                        ...
                        <label for="role_charity">
                            <svg viewBox="0 0 24 24" width="22" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M12 21s-8-4.5-8-11a8 8 0 0116 0c0 6.5-8 11-8 11z"/></svg>
                            Charity
                        </label>
                    </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    <label class="form-label" for="phone">Phone <span class="text-muted" style="font-weight:400">(optional)</span></label>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <span class="form-hint">Min 8 characters, include a letter and a number.</span>
